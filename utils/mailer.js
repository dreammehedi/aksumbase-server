...
//   const mailOptions = {
//     from: `"AksumBase" <${emailConfig.emailAddress}>`,
//     to: email,
...
export const sendVerificationEmail = async (email, token, clientUrl) => {
  ...
  const transporter = nodemailer.createTransport({
    host: emailConfig.emailHost || "smtp.gmail.com",
    port: emailConfig.emailPort || 465,
    secure: emailConfig.emailEncryption === "ssl", // SSL হলে true
    auth: {
      user: emailConfig.emailAddress,
